        ...
        <div className="terms-container">
            ...
            <div className="data urbanist-font">
                ...
                <p className="rule p1">
                    ...
                    for the use of the Cultural fest, IIIT Nagpur Website,
                    located at [Link of website]
                </p>
                <h2>GENERAL DATA PROTECTION REGULATIONS(GDPR)</h2>
                <p className="rule p2">
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Techfest IIIT Nagpur
                ...
                <p className="rule p1">
                    ...
                    person log on this website and is compliant with the
                ...
                <h2>COOKIES</h2>
                <p className="rule p1">
                    We employ the use of cookies. By accessing Cultural fest,
                    IIIT Nagpur, you agreed to use cookies in agreement with
                    Cultural fest IIIT Nagpur’s Privacy Policy. Most interactive
                ...
                <p className="rule p1">
                    Unless otherwise stated, Cultural fest, IIIT Nagpur and/or
                    its licensors own the intellectual property rights for all
                    material on Cultural fest IIIT Nagpur. All intellectual
                    property rights are reserved. You may access this from
                    Techfest, IIIT Nagpur for your own personal use subjected to
                    restrictions set in these terms and conditions.
                </p>
                <h2>You must not:</h2>
                <p>
                    Republish Material from Cultural fest IIIT Nagpur Sell,
                    rent, or sub-license material from Cultural fest IIIT Nagpur
                    Reproduce, duplicate or copy material from Cultural fest
                    IIIT Nagpur Redistribute content from Cultural fest IIIT
                    Nagpur
                </p>
                <p className="rule p2">
                    ...
                    Cultural fest, IIIT Nagpur does not filter, edit, publish or
                    review Comments prior to their presence on the website.
                    Comments do not reflect the views and opinions of Cultural
                    fest, IIIT Nagpur, its agents, and/or affiliates. Comments
                    reflect the views and opinions of the person who posts their
                    views and opinions. To the extent permitted by applicable
                    laws, Cultural fest, IIIT Nagpur shall not be liable for the
                ...
                <p className="rule p2">
                    Cultural fest, IIIT Nagpur reserves the right to monitor all
                ...
                <p className="rule p1">
                    ...
                    activity. You hereby grant Cultural fest, IIIT Nagpur a
                    non-exclusive license to use, reproduce, edit and authorize
                    others to use, reproduce and edit any of your Comments in
                ...
                <p className="rule p2">
                    ...
                    [dot.com](http://dot.com/) community sites; associations or
                ...
                <p className="rule p2">
                    ...
                    compensates for the absence of Techfest, IIIT Nagpur; and
                ...
                <p className="rule p2">
                    ...
                    inform us by sending an e-mail to Techfest, IIIT Nagpur.
                </p>
                <p className="rule p2">
                ...
                <p className="rule p2">
                    ...
                    follows: By use of our corporate name; By use of the uniform
                ...
                <p className="rule p1">
                    No use of Techfest, IIIT Nagpur's logo, or other artwork
                ...
                <p className="rule p1">
                    ...
                    against all claims that are rising on your Website. No
                ...
                <p className="rule p1">
                    At Cultural fest IIIT Nagpur, accessible from
                    [https://culturalfest.org/](https://techfest.org/), one of
                    our main priorities is the privacy of our visitors.
                </p>
                <h2>GENERAL DATA PROTECTION RULES (GDPR)</h2>
                <p className="rule p1">
                    We are a Data Controller of your information. CULTURAL FEST
                    IIIT NAGPUR's legal basis for collecting and using the
                    ...
                    TECHFEST IIIT NAGPUR needs to perform a contract with you
                    You have given CULTURAL FEST IIIT NAGPUR permission to do so
                    Processing your personal information is in CULTURAL FEST
                    IIIT NAGPUR legitimate interests CULTURAL FEST IIIT NAGPUR
                    needs to comply with the law CULTURAL FEST IIIT NAGPUR will
                    retain your personal information only for as long as is
                    necessary for the purposes set out in this Privacy Policy.
                    We will retain and use your information to the extent
                    necessary to comply with our legal obligations, resolve
                    disputes, and enforce our policies. If you are a European
                    Economic Area (EEA) resident, you have certain data
                    protection rights. If you wish to be informed what Personal
                    Information we hold about you and if you want it to be
                    removed from our systems, please contact us. In certain
                    circumstances, you have the following data protection
                    rights: The right to access, update or delete the
                    information we have on you. The right of rectification. The
                    right to object. The right of restriction. The right to data
                    portability The right to withdraw consent
                </p>
                <h2>LOG FILES</h2>
                <p className="rule p1">
                    Cultural fest IIIT Nagpur follows a standard procedure of
                    using log files. These files log visitors when they visit
                    websites. All hosting companies do this and are a part of
                    hosting services' analytics. The information collected by
                    log files includes internet protocol (IP) addresses, browser
                    ...
                    information. The information is for analyzing trends,
                ...
                <p className="rule p1">
                    ...
                    [culturalfest.org](http://culturalfest.org/) uses 'cookies.'
                ...
                <p className="rule p1">
                    ...
                    each of the advertising partners of Cultural Fest IIIT
                    Nagpur. Third-party ad servers or ad networks use
                    technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that
                    appear on Cultural Fest IIIT Nagpur, which are sent directly
                    to users' browser. They automatically receive your IP
                    address when this occurs. These technologies are used to
                    measure the effectiveness of their advertising campaigns
                    and/or personalize the advertising content you see on
                    websites you visit. Note that Cultural Fest IIIT Nagpur has
                    no access to or control over third-party advertisers'
                    cookies.
                </p>
                <h2>THIRD-PARTY PRIVACY POLICIES</h2>
                <p className="rule p1">
                    Cultural Fest IIIT Nagpur's Privacy Policy does not apply to
                    other advertisers or websites. Thus, we advise you to
                    ...
                    your individual browser options. For more detailed
                ...
                <p className="rule ">
                    ...
                    guide their online activity. Cultural Fest IIIT Nagpur does
                    not knowingly collect any Personal Identifiable Information
                    from children.
                </p>
            </div>
            <Footer />
