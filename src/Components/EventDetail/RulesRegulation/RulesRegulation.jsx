                        ...
                        <div key={index} className="mb-8">
                            ...
                            <ul className="list-disc m-0 md:ml-16 sm:ml-16 lg:ml-16 space-y-2">
                                {round.rules.map((rule, ruleIndex) => (
                                    <li
                                        className={`${round.highlight && round.highlight.includes(ruleIndex) && "font-extrabold"}`}
                                        key={ruleIndex}
                                    >
                                        {rule}
                                    </li>
                                ...
                                {round.disallowedProps && (
                                    <>
                                        <li className="mt-10">
                                            Props that are not allowed:
                                        </li>
                                        <ul className="list-disc ml-16 space-y-2">
                                            {round.disallowedProps.map(
                                                (prop, propIndex) => (
                                                    <li key={propIndex}>
                                                        {prop}
                                                    </li>
                        ...
                        {judgingCriteriaData.length > 0 &&
                            ...
                            <>
                                ...
                                {judgingCriteriaData.map((round, index) => {
                                    ...
                                    return (
                                        <div
                                            className="m-0 md:ml-16 sm:ml-16 lg:ml-16"
                                            key={index}
                                        >
                                            <h3 className="text-xl font-semibold mb-2 py-5">
                                                {round.title}
                                            ...
                                            {round.criteria &&
                                                round.criteria.map(
                                                    (criteria, index) => (
                                                        <ul
                                                            key={index}
                                                            className="list-disc p-0 md:pl-16 sm:pl-16 lg:pl-16 space-y-2"
                                                        >
                                                            <li>{criteria}</li>
                                                        </ul>
                                                    ),
