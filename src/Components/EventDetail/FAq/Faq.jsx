...
const FAQ = ({ items }) => {
    ...
    return (
        <div
            className="w-full h-fit flex flex-col items-center text-white py-10 px-4 relative urbanist-font font-normal"
            ref={sectionRef}
        >
            <div
            ...
            <div className="w-full max-w-3xl space-y-4">
                {items.map((item, index) => (
                    ...
                    >
                        <div className="flex justify-between items-center sm:px-10 sm:py-4 px-5 py-3">
                            <h2 className="text-base md:text-xl font-semibold p-1">
                                {item.question}
                            </h2>
                            <span
