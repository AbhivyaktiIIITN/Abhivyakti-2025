...
const Aboutsection = () => {
    ...
    return (
        <div
            ref={scope}
            id="about"
            className="body-wrapper w-screen h-[130vh] md:h-screen flex flex-col md:flex-row justify-center items-center relative p-20 overflow-hidden urbanist-font font-normal"
        >
            <div className="graffitiDrip-container absolute top-0 w-full -z-2">
                <img
                    src={graffitiDrip}
                    alt="Graffiti Drip"
                    className="graffitiDrip w-full h-screen"
                />
            </div>
            <motion.div
            ...
            >
                ...
                >
                    <p className="text-justify sm:text-md md:text-xl ">
                        Abhivyakti, the annual cultural extravaganza of IIIT
                        Nagpur, is a grand celebration of creativity, artistry,
                        and cultural diversity. True to its name, meaning
                        "expression," it offers students a vibrant platform to
                        showcase their talents, push boundaries, and foster a
                        spirit of camaraderie and collaboration. As one of the
                        most awaited campus events, it transforms the institute
                        into a lively hub of energy and artistic brilliance. The
                        fest features electrifying concerts, mesmerizing dances,
                        captivating plays, and stunning art exhibitions,
                        inspiring participants to explore their potential and
            ...
            >
                ...
                >
                    <img
                        src={statueImage}
                        alt="Statue"
                        className="class2 min-w-[450px] mdlg:min-w-[800px] z-50"
                    />
                    <img
                        src={statueSpray}
                        alt="Spray Paint 1"
                        className="class1 absolute w-[250px] md:w-[300px] mdlg:w-[400px] top-0 mr-8"
                    />
                    <img
                        src={sprayPaint2}
                        alt="Spray Paint 2"
                        className="class3 absolute w-[200px] md:w-[250px] mdlg:w-[400px] -bottom-10 right-[180px] md:-bottom-20 md:right-[150px] mdlg:right-[250px]"
                    />
                </motion.div>
            </motion.div>
        </div>
