...
function Hero() {
    ...
    return (
        <div id="hero" className="hero-container relative top-10 md:top-0" ref={scope} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} onClick={onMouseClick}>
            <div className="relative mx-auto max-w-full w-[100vw] h-auto" style={{ overflow: "hidden" }}>
                <div className="image-wrapper">
                    <div>
                        <img src="/assets/HeroLanding/museumWall.png" alt="museum" id="image-wrapper"
                            className="background-image h-screen w-auto object-cover lg:h-auto lg:w-screen"
                        />
                        <img src="assets/HeroLanding/noise.png" alt="noise overlay"
                            className="overlay-image z-20 h-screen w-auto object-cover lg:h-auto lg:w-screen"
                        />
                        <div className="gradient-effect"></div>
                    </div>
                    <img src="assets/HeroLanding/blueTone.png" alt="blue tone" id="blue-tone"
                        className="absolute min-h-screen z-30 top-1" style={{ opacity: 0 }}
                    />
                    <img src="assets/HeroLanding/brickWall.png" alt="brick wall" id="brick-wall"
                        className="absolute top-1 h-screen w-auto object-cover lg:h-auto lg:w-screen" style={{ opacity: 0 }}
                    />
                    <img src="assets/HeroLanding/graffitiLayer.png" alt="graffitiLayer" id="graffiti-Layer"
                    ...
                    <div className="frame-wrapper z-40 lg:w-[30%] min-w-[400px] lg:left-[51%] lg:top-[57%] top-[56.5%] left-[52%]" id="full-frame">
                        <img src="assets/HeroLanding/frame.png" alt="frame" id="frame" className="frame-image" />
                        <img src="assets/HeroLanding/frameImg.jpeg" alt="framed content"
                            id="framed-content" className="inner-frame-image" />
                    </div>
                    <img src="assets/HeroLanding/radialShine.png" alt="radial shine"
                        className="absolute z-20 top-[15%] left-[24.5%] w-[55%] h-auto"
                        id="radial-shine" style={{ opacity: 0 }}
                    />
                    <div className="main-title-wrapper z-50 cursor-pointer md:w-1/2 w-[400px]">
                        <img src="assets/HeroLanding/abhivyaktiNoShine.png" alt="main title preload"
                            className="absolute"
                            id="main-title-preload"
                        />
                        <img src="assets/HeroLanding/abhivyaktiShine.png" alt="main title shine"
                            className="absolute" style={{ opacity: 0 }}
                            id="main-title-shine"
                        />
                        <img src="assets/HeroLanding/abhivyakti.png" alt="abhivyakti"
                            className="absolute" style={{ opacity: 0 }}
                            id="abhivyakti"
                        />
                        <img src="assets/HeroLanding/2025.png" alt="year"
                            className="absolute md:w-[8.5vw] md:top-[11vw] md:left-[20.5vw] z-30 w-1/4 left-[35%] top-[90px]"
                            id="year"
                        />
                        <img src="assets/HeroLanding/2025Pink.png" alt="year pink"
                            className="absolute md:w-[12.2vw] md:top-[9.3vw] md:left-[18.6vw] z-30 w-[35.6%] left-[29.9%] top-[71px]"
                            id="year-pink" style={{ opacity: 0 }}
                        />
                        <img src="assets/HeroLanding/artMovement.png" alt="art movement"
                            className="absolute md:w-[13vw] md:top-[11vw] md:left-[18vw] z-10 w-[40%] left-[30%] top-[90px]"
                            id="art-movement"
                        />
                        <img src="assets/HeroLanding/underground.png" alt="underground"
                            className="absolute lg:w-[11.5vw] lg:top-[11vw] lg:left-[10vw] z-30 w-[33%] top-[110px]"
                            id="underground" style={{ opacity: 0 }}
                        />
                        <img src="assets/HeroLanding/undergroundArtMovementPink.png" alt="undergroundArtMovementPink"
                            className="absolute lg:w-[25vw] lg:top-[11vw] lg:left-[12vw] w-[79%] left-[15%] top-[90px]"
                            id="underground-Art-Movement-Pink" style={{ opacity: 0 }}
                        />
                        <img src="assets/HeroLanding/man.png" alt="mans"
                            ...
                            id="mans" style={{ opacity: 0 }}
                        />
                        <img src="assets/HeroLanding/graffitiGuy.png" alt="graffiti guy"
                            className="absolute lg:w-[70vw] lg:h-auto lg:top-[7vw] lg:left-[1%] z-40 w-[500px] h-[600px] top-[100px] left-[0%]"
                            id="graffiti-guy" style={{ opacity: 0, transform: "translateY(40vw)" }}
                        />
                        <img src="assets/HeroLanding/sprayHandLong.png" alt="spray hand long"
                            className="absolute lg:top-[16vw] lg:left-[-700%] z-40 top-[105vw]"
                            id="spray-hand-long" style={{ opacity: 0 }}
                        />
                        <img src="assets/HeroLanding/graffitiManSpray.png" alt="graffiti man spray"
                            className="absolute lg:w-[35vw] lg:top-[292vw] lg:left-[7.5vw] w-[400px] h-auto md:left-[4vw] z-10 top-[290vw]"
                            id="graffiti-man-spray" style={{ opacity: 1 }}
                        />
                    </div>
                </div>
            </div>
