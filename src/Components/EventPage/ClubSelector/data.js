        ...
        events: [
            {
                ...
                eventheader: {
                    ...
                    eventDescription:
                        "/assets/EventDetail/dtaraxia/SoloDance.png",
                    ClubLogo: "/assets/EventDetail/dtaraxia/ClubLogo.png",
                    bgUrlRight:
                        "linear-gradient(158.35deg, #FDFDFB 0%, #FE5013 100%)",
                    bgUrlLeft: "url(/assets/EventDetail/dtaraxia/Event-bg.png)",
                    leftStatueUrl:
                        "/assets/EventDetail/dtaraxia/statue-left.png",
                    rightStatueUrl:
                        "/assets/EventDetail/dtaraxia/statue-right.png",
                },
                eventPrize: {
                    prizeData: [
                        {
